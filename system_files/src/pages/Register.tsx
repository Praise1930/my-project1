...
import { supabase, isSupabaseConfigured, deleteSupabaseAuthUser, buildVerifyRedirectUrl } from '../services/supabase';
...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isSupabaseConfigured && supabase) {
        const verifyRedirectUrl = buildVerifyRedirectUrl(submissionData.email, 'mother');
